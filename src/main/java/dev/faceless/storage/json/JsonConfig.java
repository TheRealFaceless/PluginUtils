package dev.faceless.storage.json;
...
public class JsonConfig {
    ...
    private static final Logger LOGGER = PluginUtils.getPlugin().getSLF4JLogger();
    ...
    private void init() throws IOException {
        File configFile = relativeFromPluginsFolder ? new File(PluginUtils.getPlugin().getDataFolder(), path) : new File(path);
