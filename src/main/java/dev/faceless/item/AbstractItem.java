package dev.faceless.item;

import dev.faceless.PluginUtils;
import dev.faceless.util.PersistentDataContainerStringAdapter;
...
public class AbstractItem {
    public static NamespacedKey ABSTRACT_ITEM_KEY = new NamespacedKey(PluginUtils.getPlugin(), "abstract-item-key");
