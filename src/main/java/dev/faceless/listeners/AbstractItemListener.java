...
import dev.faceless.item.AbstractItem;
import dev.faceless.item.AbstractItemManager;
...
public class AbstractItemListener {
    public static final NamespacedKey PROJECTILE_KEY = new NamespacedKey(PluginUtils.getPlugin(), "projectile-key");
